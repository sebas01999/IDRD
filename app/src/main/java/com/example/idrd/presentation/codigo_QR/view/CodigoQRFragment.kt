...
import com.example.idrd.presentation.codigo_QR.codigo_QR_Presener.CodigoQRPresenter
...
class CodigoQRFragment : Fragment(), CodigoQRContract.RegistroEntradaView ,CoroutineScope {
    lateinit var presenter: CodigoQRPresenter
    ...
    override fun onCreateView(
        ...
        presenter= CodigoQRPresenter((RegistroEntradaInteractorImpl()))
