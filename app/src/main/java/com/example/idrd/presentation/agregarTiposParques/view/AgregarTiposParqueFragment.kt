...
class AgregarTiposParqueFragment : DialogFragment(), AgregarTipoParqueContract.AgregarTipoView {
    ...
    override fun addTipoParque() {
        ...
        var tipoParque=TiposParque()
        tipoParque.tipo=tipo
        presenter.addTipoParque(tipoParque)
